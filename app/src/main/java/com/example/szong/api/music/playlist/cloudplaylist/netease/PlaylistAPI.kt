package com.example.szong.api.music.playlist.cloudplaylist.netease
...
object PlaylistAPI {
    ...
    private fun getPlaylistUid(
        ...
        val url = PLAYLIST_URL + playlistId + "&cookie=${NeteaseUser.cookie}"
...
//                    .add("c", c3)
    ...
    fun getPlaylistByCookie(playlistId: Long, success: (ArrayList<StandardSongData>) -> Unit) {
        ...
        val api = "${NeteaseUser.cookie}/playlist/detail"
        try {
