...
import com.example.szong.ui.player.LyricUtil.formatTime
import com.example.szong.ui.player.LyricUtil.getContentFromNetwork
...
class LyricViewX @JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var lyricEntryList: MutableList<LyricEntry> = ArrayList() // 单句歌词集合
    private var lyricPaint = TextPaint() // 歌词画笔
    private var timePaint = TextPaint() // 时间文字画笔
