package com.example.szong.ui.playlist.adapter
...
class SongAdapter(
    ...
    inner class ViewHolder(view: View, itemMenuClickedListener: (StandardSongData) -> Unit) : RecyclerView.ViewHolder(view) {
        ...
        val isAnimation = mmkv.decodeBool(AppConfig.PLAYLIST_SCROLL_ANIMATION, true)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder) {
            ...
            clSong.setOnClickListener {
                if (song.neteaseInfo?.pl != 0 || mmkv.decodeBool(AppConfig.AUTO_CHANGE_RESOURCE)) {
