package com.example.szong.ui.player.viewmodel
...
class PlayerViewModel: ViewModel() {
    ...
    var lyricTranslation = MutableLiveData<Boolean>().also {
        it.value = App.mmkv.decodeBool(AppConfig.LYRIC_TRANSLATION, true)
    }
    ...
    fun setLyricTranslation(open: Boolean) {
        ...
        // updateLyric()
        App.mmkv.encode(AppConfig.LYRIC_TRANSLATION, open)
    }
