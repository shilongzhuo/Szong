...
package com.example.szong.manager
...
object User {
    ...
    val szongUser: SzongUser = mmkv.decodeParcelable(Config.SZONG_USER, SzongUser::class.java, SzongUser())
...
//    }
     ...
     */
    private fun save() {
        mmkv.encode(Config.SZONG_USER, this)
    }
