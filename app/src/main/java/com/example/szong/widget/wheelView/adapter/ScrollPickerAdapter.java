package com.example.szong.widget.wheelView.adapter;
...
import com.example.szong.widget.wheelView.IPickerViewOperation;
import com.example.szong.widget.wheelView.IViewProvider;

import java.util.ArrayList;
import java.util.List;

public class ScrollPickerAdapter<T>
        extends RecyclerView.Adapter<ScrollPickerAdapter.ScrollPickerAdapterHolder>
        implements IPickerViewOperation {
    ...
    public ScrollPickerAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ScrollPickerAdapterHolder(LayoutInflater.from(mContext)
                .inflate(mViewProvider.resLayout(), parent, false));
    }
